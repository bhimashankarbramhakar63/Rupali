...
public class Sample2_varifying_HRM {
	
	@Test
	public void varifying_Orange_HRM() throws InterruptedException {
		...
		System.out.println("The title of the orange HRM logo us : " + title);
